        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold leading-tight mb-6">
              Discover the <span className="text-ayurGold-400 italic">Root</span> of True Hair Health
            </h1>
            
            <p className="text-lg md:text-xl text-herbal-100 mb-8 max-w-2xl mx-auto lg:mx-0 font-light leading-relaxed">
              Ditch the chemicals. Experience the 5000-year-old science of pure Ayurveda. Clinically proven formulations to heal your hair from the inside out.
            </p>
